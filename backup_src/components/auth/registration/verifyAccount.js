...
const VerifyAccount = (props) => {
    ...
    const mfaUnverifiedToken = unauthorizedToken ? unauthorizedToken : memberRegister?.data?.mfaToken;
    ...
    const verifiedChannelCheck = () => {
        const verfiedChannels = mfaFactors?.data?.channels.filter( channel => channel.verificationStatus);
