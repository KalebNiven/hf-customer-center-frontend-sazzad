...
const CoverageBenefitsVideoCards = (props) => {
    ...
    return(
          (videoData.length > 0) && <BenefitVideoContainer>
            <VideoContainerHeader>How to Utilize Your Benefits</VideoContainerHeader>
            <VideoCardContainer>
                {
                    videoData && videoData.map( video => 
                        <VideoCard key={video.videoId} onClick={() => {handleVideoCardClick(video.name, video.player_embed_url)}}>
                            <VideoCardImgContainer>
                                <VideoCardImg onMouseOver={e => (e.currentTarget.src = video.pictures.sizes[5].link_with_play_button)} onMouseOut={e => (e.currentTarget.src = video.pictures.sizes[5].link)} alt={video.name} src={video.pictures.sizes[5].link}></VideoCardImg>
            ...
            {showPlayer && <VideoPopupPlayer toggleVideo={toggleVideo} embedLink={currentEmbedLink}></VideoPopupPlayer>}
