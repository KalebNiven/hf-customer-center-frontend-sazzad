...
import { Wrapper, Hero, HeroContentWrapper, HeroLeftSection, HeroTitle, HeroDescription, HeroRightSection, HeroCard, HeroCardHeading, HeroCardBalanceWrapper, HeroCardBalance, HeroCardBalanceFrequency, HeroCardPlanName, HeroCardNote, ModalParagraph, Body, Heading, BodyDescription, HowItWorksContentWrapper, StepsToActiveList, StepsToActiveListItem, StepsToActiveListItemItemNumberWrapper, StepsToActiveListItemItemNumber, StepsToActiveListItemHeading, Paragraph, StepsToActiveListItemNote, ParticipatingLocationsWrapper, ParticipatingLocationsTitle, ParticipatingLocationsSubTitle, ParticipatingLocationsLogosWrapper, ParticipatingLocationsNote, WaysToSpendWrapper, WaysToSpendCards, WaysToSpendCard, WaysToSpendCardIcon, WaysToSpendCardTitle, WaysToSpendCardDescription, WaysToSpendCardButton, LimitationSectionWrapper, LimitationSectionTitle, StepsToActiveListItemContent, LimitationsContent, LimitationsListItem, LimitationsList, PhoneBold } from '../styles';
...
const planName = "Connection Plan (HMO D-SNP)"

const ConnectionHMOPage = () => {
    ...
    const modals = { 
      ...
      HealthyFoods: { 
        ...
        content: () => (
          <>
            <ModalParagraph><b>Save on fresh fruits, vegetables and more at GrowNYC locations</b></ModalParagraph>
            <ModalParagraph>As a Connection Plan member, you can use your OTC Plus card at Greenmarkets, Farmstands, or Fresh Food Box locations in GrowNYC’s network.</ModalParagraph>
            <ModalParagraph>Visit <ExternalSiteLink link={growNYC.url} target="_blank" label="GrowNYC food retail site" styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>{growNYC.url.slice(8)}</ExternalSiteLink> to locate a GrowNYC food retail site near you </ModalParagraph>
            ...
            <ModalParagraph>As a Connection Plan member, you can use your OTC Plus card to have freshly prepared meals from Mom’s Meals delivered to your home, with free shipping.</ModalParagraph>
            <ModalParagraph>Visit <ExternalSiteLink link="https://momsmeals.com/healthfirst" target="_blank" label="momsmeals"styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>momsmeals.com/healthfirst</ExternalSiteLink>. Use discount code: <b>HEALTHFIRST</b> to receive free shipping.</ModalParagraph>
            <ModalParagraph>Call <b>1-877-347-3438</b>, Monday to Friday, 8am—7pm. Please identify yourself as a Healthfirst member to receive free shipping.</ModalParagraph>
      ...
      ExerciseEquipmentAndActivityTrackers: { 
        ...
        content: () => (
          <>
            <ModalParagraph>Buy Exercise Equipment and Activity Trackers online with no-cost delivery at NationsOTC.</ModalParagraph>
            <ModalParagraph><ExternalSiteLinkSSO link={nations.url} label="Nations OTC" target="_blank" styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>Click here</ExternalSiteLinkSSO> to go to NationsOTC to place an order online or call <PhoneBold>1-877-236-7027 (TTY 711)</PhoneBold>.</ModalParagraph>
          </>
        )
      },
      HomeInternetService: { 
        ...
        content: () => (
           <>
          <ModalParagraph>To pay for your home utility bills (gas, electric, water and internet service):</ModalParagraph>
          <ModalParagraph>1. <ExternalSiteLinkSSO link={otcNetwork.url} label="OTC Network" target="_blank" styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>Click here</ExternalSiteLinkSSO>; you will then be automatically logged into your mybenefitscenter.com* account.</ModalParagraph>
          <ModalParagraph>2. Click “Locations” from the top header section</ModalParagraph>
      ...
      return (
        <>
          ...
          <WaysToSpendCard>
            ...
            <WaysToSpendCardDescription>Purchase exercise equipment and activity trackers (such as Apple® Watches, pedometers, and other fitness watches) at participating retailers and through <ExternalSiteLinkSSO link={nations.url} label="Nations OTC" target="_blank" styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>NationsOTC.</ExternalSiteLinkSSO></WaysToSpendCardDescription>
          ...
          <WaysToSpendCard>
            ...
            <WaysToSpendCardDescription>Use your OTC Plus card to pay for your home utilites including gas, electric, water, and internet service.</WaysToSpendCardDescription>
    ...
    return (
        <Wrapper>
                ...
                <HeroContentWrapper>
                    ...
                    <HeroRightSection>
                        <HeroCard>
                            ...
                            <HeroCardBalanceWrapper>
                                <HeroCardBalance>$270</HeroCardBalance><HeroCardBalanceFrequency>per quarter*</HeroCardBalanceFrequency>
                            </HeroCardBalanceWrapper>
                            <HeroCardPlanName>{planName}</HeroCardPlanName>
                            <HeroCardNote>*Any unused balance will automatically expire at the end of each quarter or upon disenrollment from the plan.</HeroCardNote>
                        </HeroCard>
                    </HeroRightSection>
                  </HeroContentWrapper>
              </Hero>
              <Body>
                ...
                <BodyDescription>With your OTC Plus card, you have the flexibility to spend your benefit in more ways and at more places. Save at your neighborhood pharmacy, farmers’ markets, online, and other participating stores.</BodyDescription>
                ...
                <ParticipatingLocationsWrapper>
                  <ParticipatingLocationsTitle>Participating Locations</ParticipatingLocationsTitle>
                  <ParticipatingLocationsSubTitle>Retailers</ParticipatingLocationsSubTitle>
                  <ParticipatingLocationsLogosWrapper>
                    <ParticipatingLocations locations={[cvs, duanereade, walmart, familyDollar, shopShop, riteAid, dollarGeneral]} />
                  </ParticipatingLocationsLogosWrapper>
                  <ParticipatingLocationsSubTitle>Home Delivery</ParticipatingLocationsSubTitle>
                  <ParticipatingLocationsLogosWrapper>
                    <ParticipatingLocations locations={[nations, momsMeals]} />
                  </ParticipatingLocationsLogosWrapper>
                  <ParticipatingLocationsSubTitle margin="0 0 24px 0">Farmer’s Markets & Produce Stands</ParticipatingLocationsSubTitle>
                  <ParticipatingLocationsLogosWrapper>
                    <ParticipatingLocations locations={[growNYC]} />
                  </ParticipatingLocationsLogosWrapper>
                  <ParticipatingLocationsNote>Plus, many local independent pharmacies</ParticipatingLocationsNote>
                </ParticipatingLocationsWrapper>
                </HowItWorksContentWrapper>
                <WaysToSpendWrapper>
                ...
                <LimitationSectionWrapper>
                  ...
                  <LimitationSectionTitle>Maximum Limits on OTC Plus Card</LimitationSectionTitle>
                  <LimitationsContent>
                    <Paragraph>As a {planName} member, your OTC Plus card has a maximum limit for purchasing the following approved items:</Paragraph>
                    <LimitationsList>
                    ...
                    <Paragraph>For more information, view your <a onClick={() =>handleSegmentClick("/learn-more","Evidence of Coverage","Evidence of Coverage","Button","/learn-more",customerInfo,"otc") } href={evidenceOfCoverageURL.ConnectionHMO.url} target="_blank">Evidence of Coverage</a> or contact Member Services.</Paragraph>
                  ...
                  <LimitationsContent>
                    <LimitationsList>
                      ...
                      <LimitationsListItem>Any unused balances will automatically expire at the end of each quarter, upon disenrollment or transfer to another Healthfirst plan</LimitationsListItem>
                      <LimitationsListItem>You cannot use your Healthfirst Member ID card, Medicare card, or Medicaid card to pay for non-prescription drugs, health-related items, healthy foods, produce, or home utilities</LimitationsListItem>
                    </LimitationsList>
                  </LimitationsContent>
                </LimitationSectionWrapper>
...
export default ConnectionHMOPage
