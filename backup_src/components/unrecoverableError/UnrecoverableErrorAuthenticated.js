...
const UnrecoverableErrorAuthenticated = (props) => {
            ...
            <ErrorWrapper>
                <ErrorContainer>
                    <ErrorCard>
                        ...
                        <ControllersWrapper>
                            <ControllersButton onClick={() => window.location.href = '/home'}>Go Home</ControllersButton>
                            <ControllersButton onClick={() => logout()}>Log Out</ControllersButton>
                        </ControllersWrapper>
                    </ErrorCard>
                </ErrorContainer>
            </ErrorWrapper>
