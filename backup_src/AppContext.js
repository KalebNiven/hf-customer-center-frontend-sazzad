...
export const AppContextProvider = ({ children }) => {
    ...
    const [externalSiteModal, setExternalSiteModal] = useState({ isVisible: false, link: "#", target: "_blank", segmentPageCategory: null, segmentTitle: null, segmentTargetMemberId: null, membershipKey: null, label: null });
