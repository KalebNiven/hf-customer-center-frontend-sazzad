...
import {
  requestPcpDetails, requestUpdatedPCPID, requestResetPcpDetails, requestPCPDetails,
...
function FindCareDetails(props) {
    ...
    const memberDetailsObj = [
      {
        ...
        disablePcpUpdate: customerInfo.membershipStatus !== "active",
      },
      ...dependentsObj,
    ];
