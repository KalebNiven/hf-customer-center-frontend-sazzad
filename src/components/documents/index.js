...
const DocumentCenter = (props) => {
  ...
  const handleSegmentBtn = (label, row, action) => {
    try {
      AnalyticsTrack(`${label} clicked`, customerInfo, {
        ...
        targetMemberId: memberSelection.relationshipType
          ? memberSelection.memberId
          : undefined,
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: true,
      sortFunction: (rowA, rowB) => {
        const aField = rowA.DisplayDocumentTypeName
          ? rowA.DisplayDocumentTypeName
          : rowA.DocumentType;
        const bField = rowB.DisplayDocumentTypeName
          ? rowB.DisplayDocumentTypeName
          : rowB.DocumentType;
  ...
  const getMmanagePaperlessLink = () => {
    return (
      <a
        className="manage"
        onClick={() => {
          handleSegmentBtn("Manage button", undefined, "Manage button");
          history.push({
            pathname: "/settings",
            state: {
              sideBarIndex: 2,
                ...
                <>
                  <Paperless>
                    ...
                    <span>
                      ...
                      <span className="option"> Paperless</span>.
                    </span>
                    <a
                      onClick={() => {
                  ...
                  <p>
                    You are no longer receiving paper mail for certain
                    communications (determination letters for Clinical, Appeals
                    & Grievances, EOBs, etc.) as these notices will now be
                    posted directly within My Documents.
                  </p>
                  <span className="text">
                    Only records from the past two years will be displayed
                    below.
                  </span>
                </>
              )}
              ...
              <DependentBlockWrapper className="no-print">
                {
                  <DependentBlock
                    ...
                    minorsOnly={true}
                    prevPlans={featureconfig.SHOW_PREVIOUS_PLANS ? true : false}
              ...
              {splitEval.evaluateSplitByName(SHOW_PAPERLESS_WIDGET) && (
                <>
                  <Paperless>
                    <LeafIcon src="/react/images/documents-leaf.svg"></LeafIcon>
                    <span>
                      <span className="option">Enroll in Paperless</span>.
                    </span>
                  </Paperless>
                  <p>
                    Enroll to get your documents online instead of by mail, and
                    save paper and time. Your documents will be sent to your
                    primary email address as they become paperless and available
                    online.
                  </p>
              ...
              <DependentBlockWrapper className="no-print">
                {
                  <DependentBlock
                    ...
                    halfWidth
                    callback={(memberInfo) => {
                      handleSegmentBtn("Select member dropdown", {}, "member");
                      setDocumentsListLoaded(false);
                      setDocumentList([]);
                    ...
                    activeOnly={
                      customerInfo.data?.accountStatus === "active"
                        ? false
                        : true
                    }
                    minorsOnly={true}
          ...
          <>
            {isMobile ? (
              <>
                <FilterButton
                  onClick={() => {
                    ...
                    handleSegmentBtn("Filter button", {}, "Filter button");
                  }}
                >
                  <span>
                    <img alt="" src="/react/images/filter.svg" />
                  </span>
              ...
              <FilterWrapper>
                ...
                {!documentRangeToggle && (startValue || endValue) ? (
                  <ClearAll
                    onClick={() => {
                      setSelectedDocumentType([]);
                      setDocumentTypeToggle(false);
        ...
        {documentRangeToggle && (
          <DocumentRangeShowWrapper>
            <div className="main">
              <DateContent>
                <DateComponent>
                  <DateWrapper ref={refRange} className="preventClose">
                    <span>From</span>
              ...
              <DateButton
                onClick={() => {
                  ...
                  handleSegmentBtn("Clear button", {}, "Clear button");
                }}
              >
                Clear
              </DateButton>
...
const Index = (props) => {
  ...
  const featureTreatment = (
    ...
    >
      <DocumentCenter
        {...props}
        splitAttributesForPaperless={splitAttributesForPaperless}
      />
    </FeatureTreatment>
  );
