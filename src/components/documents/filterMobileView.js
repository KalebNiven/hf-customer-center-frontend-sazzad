                        ...
                        <DatePicker
                            ...
                            onChange={(value) => {
                                ...
                                if (startDate > endDate) {
                                    setStartValue(moment(endValue).subtract(1, 'days').utcOffset(0,false).format("MM/DD/YYYY"));
                                    setDateRangeDisplay({
                                        ...dateRangeDisplay,
                                        start: moment(endValue).subtract(1, 'days').format("MM/DD/YYYY"),
                                    });
                                    getDocuments(null,null,moment(endValue).subtract(1, 'days').format("YYYY-MM-DD"));
                                } else {
                                    setStartValue(moment(value).utcOffset(0,false).format("MM/DD/YYYY"));
                                    setDateRangeDisplay({
                                        ...dateRangeDisplay,
                    ...
                    <MuiPickersUtilsProvider utils={DateFnsUtils}>
                        <DatePicker
                            ...
                            onChange={(value) => {
                                ...
                                if (startDate > endDate) {
                                    setEndValue(moment(startValue).add(1, 'days').utcOffset(0,false).format("MM/DD/YYYY"));
                                    setDateRangeDisplay({
                                        ...dateRangeDisplay,
                                        end: moment(startValue).add(1, 'days').format("MM/DD/YYYY"),
                                    });
                                    getDocuments(null,null,moment(startValue).add(1, 'days').format("YYYY-MM-DD"));
                                } else {
                                    setEndValue(moment(value).utcOffset(0,false).format("MM/DD/YYYY"));
                                    setDateRangeDisplay({
                                        ...dateRangeDisplay,
                                        end: moment(value).format("MM/DD/YYYY"),
                                    });
                                    getDocuments(null,null,null,moment(value).format("YYYY-MM-DD"));
                                }
                                setDocumentsListLoaded(false);
                            }}
                            placeholder=" mm/dd/yyyy"
