                        ...
                        <Container>
                            ...
                            {surveyStatuses ? (
                                <HRAWrapper>
                                    <CardMain>
                                        <CardNav>
                                            ...
                                            <InlineInnerContainer>
                                                ...
                                                <Content>
                                                    ...
                                                    help us to meet your health
                                                    care needs. This survey is
                                                    confidential and will NOT
                                                    affect your healthcare
                                                    coverage. If you have any
                                                    other questions about this
                                                    Health Questionnaire, please
                                                    call Member Services.
                                                </Content>
                                            </InlineInnerContainer>
                                        </CardNav>
                                        <HorizontalDivider />
                                        {atleastOneMemberValid(
                                            customerInfo
                                        ) && (
                                            <HealthResources
                                        ...
                                        <Main>
                                            ...
                                            <HealthResourcesChevron
                                                currentMemberInfo={customerInfo}
                                            />
                                        </Main>
                                        {resoucesVisible.includes(
                                            customerInfo.memberId
                                        ) && (
                                            <DropDownContent
                                                content={
                                        ...
                                        {customerInfo?.dependents &&
                                            customerInfo?.dependents.length >
                                                0 &&
                                            customerInfo?.dependents.map(
                                                (eachDependent, idx) => {
                                                    return (
                                                        <Fragment key={idx}>
                                                            <HorizontalDivider />
                                    ...
                                    {atleastOneMemberComplete(
                                        surveyLocalStatuses
                                    ) && generalResources?.length > 0 ? (
                                        <GeneralHealthResources
                                            content={generalResources}
                                        />
                                    ) : generalResourcesLoader ? (
                                        <SpinnerWrapper>
                                            <Spinner />
