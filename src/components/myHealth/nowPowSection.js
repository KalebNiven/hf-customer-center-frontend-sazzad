    ...
    return (
        <Wrapper>
            <Container>
                ...
                <SubText>
                    The Community Resources are provided for your information
                    only and are not covered by your Healthfirst plan.
                </SubText>
                <SubHeader>Find Resources Near</SubHeader>
                <InputOuter hasError={zipInputError.length}>
                    <MapImg
                        src={`/react/images/${
                            zipInputError.length
                                ? "icn-map-red.svg"
                                : "icn-map.svg"
                        }`}
                    />
