...
const MyHealthPage = () => {
    ...
    const handleSegment = (label,href,description) =>{
        handleSegmentClick(href, label, description, "link", "bottom",customerInfo, "myHealth");
        history.push(href)
    }
                ...
                {showHRACard && <Card>
                    <Wrapper>
                        ...
                        <ContentWrapper>
                            ...
                            <Content>
                                Please complete this voluntary Health
                                Questionnaire. This will help us to meet your
                                health care needs. This survey is confidential
                                and will NOT affect your healthcare coverage. If
                                you have any other questions about this Health
                                Questionnaire, please call Member Services.{" "}
                            </Content>
                            <Navigator
                                onClick={() =>
                                    handleSegment("Take Assessment","/my-health/annual-health-assessment","Annual Health Assessment")
                                }
                            >
                                Take Assessment
                            </Navigator>
                ...
                <Card>
                    <Wrapper>
                        ...
                        <ContentWrapper>
                            ...
                            <Content>
                                Based on a number of factors (including your
                                age, gender, and health history), you should
                                consider completing the following activities.
                                These recommendations are based on data
                                available to Healthfirst.
                            </Content>
                            <Navigator
                                onClick={() =>
                                    handleSegment("View My Health Checklist","/my-health/my-health-checklist","My Health Checklist")
                                }
                            >
                ...
                <Card>
                    <Wrapper>
                        ...
                        <ContentWrapper>
                            ...
                            <Content>
                                Find essential services nearby—food, housing,
                                education, financial and legal assistance, and
                                more.
                            </Content>
                            <Navigator
                                onClick={() =>
                                    handleSegment("Browse Resources","/my-health/community-resources","Community Resources")
                                }
                            >
                                Browse Resources
                            </Navigator>
