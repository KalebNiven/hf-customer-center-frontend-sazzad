...
export const HealthResourcesContextProvider = ({ children }) => {
    ...
    return(
        <HealthResourcesContext.Provider value={{ surveyLocalStatuses, setSurveyLocalStatuses, currentResources, setCurrentResources, resoucesVisible, setResoucesVisible, generalResources, setGeneralResources, currentCompanyCodes, setCurrentCompanyCodes, generalResourcesLoader, setGeneralResourcesLoader }}>{children}</HealthResourcesContext.Provider>
    )
}
