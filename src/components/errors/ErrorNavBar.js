...
const ErrorNavBar = () => {
  ...
  const getParentNav = () => {
    return (
      <div id="navbar" style={{ display: 'flex', height: '64px', paddingLeft: "15px", alignItems: 'center', justifyContent: 'center' }}>
                                ...
                                childNav.treatmentName ?
                                  ...
                                  >
                                    <ListItem className={classes.gutters} onClick={(e) => handleClickMobile(e, childNav.href, 'child', childNav?.label,childNav?.labelForSegment)} button>
                                      <ListItemIcon>{<LogoImg src={childNav.inactiveIcon} />}</ListItemIcon>
                                      <ListItemText className={'child-tab-inactive'}>{childNav.label}</ListItemText>
                                    </ListItem>
                                  </FeatureTreatment>) : (
            ...
            <DrawerOverlay display={drawerOpen} >
              ...
              >
                ...
                <Bottom>
                  ...
                  <NavLogout
                    route="JSON"
                    onClick={(e) => { handleClick(e, 'member-logout', '', 'Log Out','Log Out') }} > Log Out
                  </NavLogout>
                  </NavLogoutContainer>
                </Bottom>
              </Drawer>
