    ...
    HealthyFoods: {
      ...
      content: () => (
        <>
          ...
          <ModalParagraph>
            As a Connection Plan member, you can use your OTC Plus card at
          ...
          <ModalParagraph>
            As a Connection Plan member, you can use your OTC Plus card to have
            freshly prepared meals from Mom’s Meals delivered to your home, with
            free shipping.
          </ModalParagraph>
          <ModalParagraph>
            Visit{" "}
      ...
      <>
        ...
        <WaysToSpendCard>
          ...
          <WaysToSpendCardDescription>
            ...
            Watches, pedometers, and other fitness watches) at participating
            retailers and through{" "}
            <ExternalSiteLinkSSO
              link={nations.url}
              label="Nations OTC"
              target="_blank"
        ...
        <WaysToSpendCard>
          ...
          <WaysToSpendCardDescription>
            Use your OTC Plus card to pay for your home utilites including gas,
        ...
        <HeroContentWrapper>
          ...
          <HeroRightSection>
            <HeroCard>
              ...
              <HeroCardBalanceWrapper>
                <HeroCardBalance>$270</HeroCardBalance>
                <HeroCardBalanceFrequency>
                  per quarter*
                </HeroCardBalanceFrequency>
              </HeroCardBalanceWrapper>
          ...
          <LimitationsContent>
            <LimitationsList>
              ...
              <LimitationsListItem>
                ...
                quarter, upon disenrollment or transfer to another Healthfirst
                plan
              </LimitationsListItem>
              <LimitationsListItem>
