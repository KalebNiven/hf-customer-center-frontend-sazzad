      ...
      HealthyFoods: { 
        ...
        content: () => (
          <>
            ...
            <ModalParagraph>As a CompleteCare member, you can use your OTC Plus card at Greenmarkets, Farmstands, or Fresh Food Box locations in GrowNYC’s network.</ModalParagraph>
            <ModalParagraph>Visit <ExternalSiteLink label="GrowNYC food retail site" link={growNYC.url} target="_blank" styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>{growNYC.url.slice(8)}</ExternalSiteLink> to locate a GrowNYC food retail site near you </ModalParagraph>
      ...
      ExerciseEquipmentAndActivityTrackers: { 
        ...
        content: () => (
          <>
            ...
            <ModalParagraph><ExternalSiteLinkSSO link={nations.url} label="Nations OTC" target="_blank" styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>Click here</ExternalSiteLinkSSO> to go to NationsOTC to place an order online or call <PhoneBold>1-877-236-7027</PhoneBold> (TTY 711).</ModalParagraph>
          </>
        )
      },
      HomeInternetService: { 
        ...
        <Wrapper>
              ...
              <Hero>
                <HeroContentWrapper>
                    <HeroLeftSection>
                        ...
                        <HeroDescription>As a <b>Healthfirst {planName}</b> member, staying healthy is easier with your OTC Plus card. 
                        Save on items you use every day, such as toothpaste, eye drops, aspirin, and more, when you shop at participating 
                        neighborhood and online stores, with no-cost home-delivery options available. In addition, 
                        you can save on OTC non-prescription drugs, healthy foods, exercise equipment, activity trackers, and home utilities.*
                        </HeroDescription>
                        <HeroDescription>
                    ...
                    <HeroRightSection>
                        <HeroCard>
                            ...
                            <HeroCardBalanceWrapper>
                                <HeroCardBalance>$180</HeroCardBalance><HeroCardBalanceFrequency>per month*</HeroCardBalanceFrequency>
                            </HeroCardBalanceWrapper>
                            <HeroCardPlanName>{planName}</HeroCardPlanName>
                            <HeroCardNote>*Any unused balance will automatically expire at the end of each month or upon disenrollment from the plan.</HeroCardNote>
                        </HeroCard>
                    </HeroRightSection>
                  </HeroContentWrapper>
              </Hero>
              <Body>
                ...
                <ParticipatingLocationsWrapper>
                  ...
                  <ParticipatingLocationsSubTitle margin="24px 0 24px 0">Farmer’s Markets & Produce Stands</ParticipatingLocationsSubTitle>
                  <ParticipatingLocationsLogosWrapper>
                ...
                <LimitationSectionWrapper>
                  ...
                  <LimitationsContent>
                    <LimitationsList>
                      <LimitationsListItem>Please activate your OTC Plus card before using to receive your allowance</LimitationsListItem>
                      ...
                      <LimitationsListItem>Any unused balances will automatically expire at the end of each month or upon disenrollment or transfer to another Healthfirst plan</LimitationsListItem>
