    ...
    return (
        <Wrapper>
                ...
                <HeroContentWrapper>
                    ...
                    <HeroRightSection>
                        <HeroCard>
                            ...
                            <HeroCardBalanceWrapper>
                                <HeroCardBalance>$70</HeroCardBalance><HeroCardBalanceFrequency>per quarter*</HeroCardBalanceFrequency>
                            </HeroCardBalanceWrapper>
              ...
              <Body>
                ...
                <BodyDescription>Use your OTC card to shop for non-prescription drugs and health-related items that help you save money and stay healthy.</BodyDescription>
                  ...
                  <StepsToActiveList>
                    ...
                    <StepsToActiveListItem margin="0">
                      ...
                      <StepsToActiveListItemContent>
                        ...
                        <Paragraph>At local stores, take your items to the checkout lanes. When you check out, swipe your OTC card for payment. Purchases of approved items are automatically deducted from your card balance.</Paragraph>
                        <Paragraph>Bring your OTC card with you, as you cannot use your Healthfirst Member ID card or Medicare card to purchase approved OTC items.</Paragraph>
                ...
                <ParticipatingLocationsWrapper>
                  ...
                  <ParticipatingLocationsLogosWrapper>
                    <ParticipatingLocations locations={[cvs, duanereade, walmart, familyDollar, walgreens, riteAid, dollarGeneral]} />
                  </ParticipatingLocationsLogosWrapper>
                ...
                <LimitationSectionWrapper>
                  ...
                  <LimitationSectionTitle>Maximum Limits on OTC Card</LimitationSectionTitle>
                  <LimitationsContent>
                    <Paragraph>As a {planName} member, your OTC card has a maximum limit for purchasing the following approved items:</Paragraph>
                    <LimitationsList>
                  ...
                  <LimitationsContent>
                    <LimitationsList>
                      ...
                      <LimitationsListItem>You cannot use your Healthfirst Member ID card or Medicare card to pay for non-prescription drugs and health-related items</LimitationsListItem>
                    </LimitationsList>
                  </LimitationsContent>
                </LimitationSectionWrapper>
