    ...
    const modals = { 
      ...
      HealthyFoods: { 
        ...
        content: () => (
          <>
            ...
            <ModalParagraph>As a Life Improvement Plan member, you can use your OTC Plus card at Greenmarkets, Farmstands, or Fresh Food Box locations in GrowNYC’s network.</ModalParagraph>
            <ModalParagraph>Visit <ExternalSiteLink link={growNYC.url} label="GrowNYC food retail site"  target="_blank" styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>{growNYC.url.slice(8)}</ExternalSiteLink> to locate a GrowNYC food retail site near you </ModalParagraph>
            ...
            <ModalParagraph>As a Life Improvement Plan member, you can use your OTC Plus card to have freshly prepared meals from Mom’s Meals delivered to your home, with free shipping.</ModalParagraph>
            <ModalParagraph>Visit <ExternalSiteLink link="https://momsmeals.com/healthfirst" label="momsmeals"  target="_blank" styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>momsmeals.com/healthfirst</ExternalSiteLink>. Use discount code: <b>HEALTHFIRST</b> to receive free shipping.</ModalParagraph>
            <ModalParagraph>Call <PhoneBold>1-877-347-3438</PhoneBold>, Monday to Friday, 8am—7pm. Please identify yourself as a Healthfirst member to receive free shipping.</ModalParagraph>
      ...
      PersonalEmergencyResponseSystems: { 
        ...
        content: () => (
          <>
            <ModalParagraph>
            <ExternalSiteLinkSSO link={nations.url} label="Nations OTC" target="_blank" styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>Click here</ExternalSiteLinkSSO> to go to NationsOTC to place an order online or call <PhoneBold>1-877-236-7027</PhoneBold> (TTY 711). 24 hours per day, 7 days a week.
            </ModalParagraph>
          </>
        )
      },
      HearingAidCopays: { 
        title: "Hearing Aid Copays",
        content: () => (
          <>
            <ModalParagraph>
              For more information, call NationsHearing at <PhoneBold>1-877-438-7251</PhoneBold> (TTY 711) or visit <ExternalSiteLink link={nationsHearing.url} label="NationsHearing" target="_blank" styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>NationsHearing</ExternalSiteLink>.
            </ModalParagraph>
          </>
        )
      }
                ...
                <HeroContentWrapper>
                    ...
                    <HeroRightSection>
                        <HeroCard>
                            ...
                            <HeroCardBalanceWrapper>
                                <HeroCardBalance>$475</HeroCardBalance><HeroCardBalanceFrequency>per quarter*</HeroCardBalanceFrequency>
                            </HeroCardBalanceWrapper>
              ...
              <Body>
                ...
                <ParticipatingLocationsWrapper>
                  ...
                  <ParticipatingLocationsLogosWrapper>
                    <ParticipatingLocations locations={[cvs, duanereade, walmart, familyDollar, shopShop, dollarGeneral, riteAid]} />
                  </ParticipatingLocationsLogosWrapper>
                ...
                <LimitationSectionWrapper>
                  ...
                  <LimitationsContent>
                    <LimitationsList>
                      ...
                      <LimitationsListItem>You cannot use your Healthfirst Member ID card, Medicare card, or Medicaid card to pay for non-prescription drugs and health-related items, healthy foods, produce, or home utilities</LimitationsListItem>
                    </LimitationsList>
                  </LimitationsContent>
                </LimitationSectionWrapper>
...
export default LifeImprovementHMOPage
