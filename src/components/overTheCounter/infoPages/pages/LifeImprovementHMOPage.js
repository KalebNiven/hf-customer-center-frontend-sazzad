  ...
  const modals = {
    ...
    HealthyFoods: {
      ...
      content: () => (
        <>
          ...
          <ModalParagraph>
            As a Life Improvement Plan member, you can use your OTC Plus card at
          ...
          <ModalParagraph>
            <b>
              Have freshly prepared meals delivered to your home with Mom’s
              meals
            </b>
          </ModalParagraph>
          <ModalParagraph>
            As a Life Improvement Plan member, you can use your OTC Plus card to
            have freshly prepared meals from Mom’s Meals delivered to your home,
            with free shipping.
          </ModalParagraph>
          <ModalParagraph>
            Visit{" "}
            <ExternalSiteLink
              link="https://momsmeals.com/healthfirst"
              label="momsmeals"
              target="_blank"
              styles={{ color: "#008bbf", cursor: "pointer", fontWeight: 700 }}
            >
              momsmeals.com/healthfirst
            </ExternalSiteLink>
            . Use discount code: <b>HEALTHFIRST</b> to receive free shipping.
          </ModalParagraph>
          <ModalParagraph>
            Call <PhoneBold>1-877-347-3438</PhoneBold>, Monday to Friday,
            8am—7pm. Please identify yourself as a Healthfirst member to receive
            free shipping.
          </ModalParagraph>
        </>
      ),
      ...
      content: () => (
        <>
          ...
          <ModalParagraph>
            ...
            to go to NationsOTC to place an order online or call{" "}
            <PhoneBold>1-877-236-7027 (TTY 711)</PhoneBold>.
          </ModalParagraph>
        </>
      ),
    },
      ...
      content: () => (
        <>
          ...
          <ModalParagraph>
            ...
            out the{" "}
            <a
              href={reimbursementFormsURL.LifeImprovements.url}
              target="_blank"
            >
      ...
      content: () => (
        <>
          <ModalParagraph>
            ...
            to go to NationsOTC to place an order online or call{" "}
            <PhoneBold>1-877-236-7027</PhoneBold> (TTY 711). 24 hours per day, 7
            days a week.
          </ModalParagraph>
        </>
      ),
    ...
    HearingAidCopays: {
      ...
      content: () => (
        <>
          <ModalParagraph>
            For more information, call NationsHearing at{" "}
            <PhoneBold>1-877-438-7251</PhoneBold> (TTY 711) or visit{" "}
            <ExternalSiteLink
              link={nationsHearing.url}
              label="NationsHearing"
              target="_blank"
              styles={{ color: "#008bbf", cursor: "pointer", fontWeight: 700 }}
            >
              NationsHearing
    ...
    return (
      <>
        ...
        <WaysToSpendCard>
          ...
          <WaysToSpendCardDescription>
            Use your OTC Plus card to pay for your home utilities, including
            gas, electric, water and internet service.
          </WaysToSpendCardDescription>
          <Wrapper
            onClick={() =>
              handleSegmentClick(
        ...
        <WaysToSpendCard>
          ...
          <WaysToSpendCardDescription>
            Personal emergency response systems provide peace of mind knowing
            that help is available with the push of a button. Each emergency
            response system is powered by ADT, one of the nation’s leading
            providers of security, automation, and safety solutions. Order your
            PERS device and monthly service through NationsOTC.
          </WaysToSpendCardDescription>
          <Wrapper
            onClick={() =>
              handleSegmentClick(
          ...
          >
            <WaysToSpendCardButton
              onClick={() => openModal(modals.PersonalEmergencyResponseSystems)}
            >
              Learn more
            </WaysToSpendCardButton>
          </Wrapper>
        ...
        <WaysToSpendCard>
          ...
          <WaysToSpendCardDescription>
            ...
            aids through a participating audiologist.{" "}
            <ExternalSiteLink
              link={nationsHearing.url}
              label="NationsHearing"
              target="_blank"
            ...
            to go to your NationsHearing account or call NationsHearing at{" "}
            <PhoneBold> 1-877-438-7251 (TTY 711) </PhoneBold> to find an
          ...
          >
            <WaysToSpendCardButton
              onClick={() => openModal(modals.HearingAidCopays)}
            >
              Learn more
            </WaysToSpendCardButton>
          </Wrapper>
        ...
        <HeroContentWrapper>
          <HeroLeftSection>
            ...
            <HeroDescription>
              ...
              non-prescription drugs, healthy foods, personal emergency response
              systems (PERS), exercise equipment, activity trackers, home
              utilities, and hearing aid copays.*
            </HeroDescription>
            <HeroDescription>
          ...
          <HeroRightSection>
            <HeroCard>
              ...
              <HeroCardBalanceWrapper>
                <HeroCardBalance>$475</HeroCardBalance>
                <HeroCardBalanceFrequency>
                  per quarter*
                </HeroCardBalanceFrequency>
              </HeroCardBalanceWrapper>
      ...
      <Body>
        ...
        <HowItWorksContentWrapper>
          ...
          <ParticipatingLocationsWrapper>
            ...
            <ParticipatingLocationsSubTitle margin="0 0 24px 0">
        ...
        <LimitationSectionWrapper>
          ...
          <LimitationsContent>
            ...
            <Paragraph>
              ...
              provider, who will recommend the right OTC Plus items for a
          ...
          <LimitationsContent>
            <LimitationsList>
              ...
              <LimitationsListItem>
                ...
                or Medicaid card to pay for non-prescription drugs and
