      ...
      HealthyFoods: { 
        ...
        content: () => (
          <>
            ...
            <ModalParagraph>As a Increased Benefits Plan member, you can use your OTC Plus card at Greenmarkets, Farmstands, or Fresh Food Box locations in GrowNYC’s network.</ModalParagraph>
            ...
            <ModalParagraph>As a Increased Benefits Plan member, you can use your OTC Plus card to have freshly prepared meals from Mom’s Meals delivered to your home, with free shipping.</ModalParagraph>
            ...
            <br/>
            <ModalParagraph>*For members with Extra Help; members without Extra Help can use their OTC Plus card for OTC and health-related items only.</ModalParagraph>
          </>
        )
      },
      HomeInternetService: { 
    ...
    return (
        <Wrapper>
                ...
                <HeroContentWrapper>
                    ...
                    <HeroRightSection>
                        <HeroCard>
                            ...
                            <HeroCardBalanceWrapper>
                                <HeroCardBalance>$100</HeroCardBalance><HeroCardBalanceFrequency>per quarter*</HeroCardBalanceFrequency>
                            </HeroCardBalanceWrapper>
              ...
              <Body>
                ...
                <BodyDescription>With your OTC Plus card, you have the flexibility to spend your benefit in more ways and at more places. Save at your neighborhood pharmacy, online, and other participating stores. Plus, if you have Extra Help (Low Income Subsidy), you can also use your OTC Plus card for healthy foods and home utilities.*</BodyDescription>
                ...
                <LimitationSectionWrapper>
                  ...
                  <LimitationsContent>
                    <Paragraph>As a Increased Benefits Plan member, your OTC Plus card has a maximum limit for purchasing the following approved items:</Paragraph>
                    <LimitationsList>
...
export default IncreasedBenefitsHMOPage
