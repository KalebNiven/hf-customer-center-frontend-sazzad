    ...
    HealthyFoods: {
      ...
      content: () => (
        <>
          ...
          <ModalParagraph>
            As a Increased Benefits Plan member, you can use your OTC Plus card
            at Greenmarkets, Farmstands, or Fresh Food Box locations in
            GrowNYC’s network.
          </ModalParagraph>
          <ModalParagraph>
            Visit{" "}
          ...
          <ModalParagraph>
            As a Increased Benefits Plan member, you can use your OTC Plus card
            to have freshly prepared meals from Mom’s Meals delivered to your
          ...
          <ModalParagraph>
            Call <b>1-877-347-3438</b>, Monday to Friday, 8am—7pm. Please
            identify yourself as a Healthfirst member to receive free shipping.
          </ModalParagraph>
          <br />
          <ModalParagraph>
            *For members with Extra Help; members without Extra Help can use
            their OTC Plus card for OTC and health-related items only.
          </ModalParagraph>
        </>
      ),
    },
    HomeInternetService: {
      ...
      content: () => (
        <>
          ...
          <ModalParagraph isExtraMargin="35px 0px 13px">
            *For members with Extra Help; members without Extra Help can use
            their OTC Plus card for OTC and health-related items only.
          </ModalParagraph>
        </>
    ...
    return (
      <>
        ...
        <WaysToSpendCard>
          ...
          <WaysToSpendCardTitle>
            Healthy Foods (if you have Extra Help)
          </WaysToSpendCardTitle>
          <WaysToSpendCardDescription>
        ...
        <WaysToSpendCard>
          ...
          <WaysToSpendCardTitle>
            Home Utilities (if you have Extra Help)
          </WaysToSpendCardTitle>
          <WaysToSpendCardDescription>
            Use your OTC Plus card to pay for most home utilities, including
    ...
    <Wrapper>
        ...
        <HeroContentWrapper>
          <HeroLeftSection>
            ...
            <HeroDescription>
              ...
              home-delivery options available. Plus, if you have Extra Help (Low
              Income Subsidy), you can also use your OTC Plus card for health
              foods and home utilites.*
            </HeroDescription>
            <HeroDescription>
          ...
          <HeroRightSection>
            <HeroCard>
              ...
              <HeroCardBalanceWrapper>
                <HeroCardBalance>$100</HeroCardBalance>
                <HeroCardBalanceFrequency>
                  per quarter*
                </HeroCardBalanceFrequency>
              </HeroCardBalanceWrapper>
      ...
      <Body>
        ...
        <BodyDescription>
          ...
          pharmacy, online, and other participating stores. Plus, if you have
          Extra Help (Low Income Subsidy), you can also use your OTC Plus card
          for healthy foods and home utilities.*
        </BodyDescription>
        <HowItWorksContentWrapper>
          <StepsToActiveList>
            <StepsToActiveListItem>
              ...
              <StepsToActiveListItemContent>
                ...
                <Paragraph>
                  Activate your OTC Plus card and bring it with you to
                  participating pharmacies and other stores.
                </Paragraph>
                <ActivateOTCCardLink />
            ...
            <StepsToActiveListItem>
              ...
              <StepsToActiveListItemContent>
                ...
                <StepsToActiveListItemNote>
                  For a complete list of participating pharmacies and stores,{" "}
                  <ExternalSiteLinkSSO
                    link={otcNetwork.url}
                    label="OTC Network"
                    target="_blank"
        ...
        <LimitationSectionWrapper>
          ...
          <LimitationsContent>
            <Paragraph>
              As a Increased Benefits Plan member, your OTC Plus card has a
              maximum limit for purchasing the following approved items:
            </Paragraph>
            <LimitationsList>
              <LimitationsListItem>
          ...
          <LimitationsContent>
            <LimitationsList>
              <LimitationsListItem>
                Please activate your card before using to receive your
                allowance.
              </LimitationsListItem>
              <LimitationsListItem>
              ...
              <LimitationsListItem>
                ...
                to pay for eligible OTC Plus card items.
              </LimitationsListItem>
            </LimitationsList>
          </LimitationsContent>
        </LimitationSectionWrapper>
