...
import {
  ...
  SHOW_COVERAGE_AND_BENEFITS, SHOW_CLAIMS, SHOW_AUTHS, SHOW_MYHEALTH, SHOW_ESTIMATECOST, SHOW_SUGGESTION_CARDS, SHOW_EXTERNAL_LINK_CARDS, SHOW_COST_ESTIMATOR_WIDGET, SHOW_MANAGE_PRESCRIPTIONS_MEMBERSHIP_TREATMENTS, SHOW_MY_REWARDS, SHOW_HEALTH_ASSESMENT_SURVEY,
...
const SSOCards = () => {
  ...
  {
    featureName: SHOW_HEALTH_ASSESMENT_SURVEY, name: "Health Assessment", img: "/react/images/icon_claims.svg", routeLink: "my-health/annual-health-assessment",
  },
  ];
