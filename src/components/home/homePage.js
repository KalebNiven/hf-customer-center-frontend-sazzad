...
const HomePage = () => {
  ...
  const firstName = primaryPlan
    ? primaryPlan?.FirstName
                    ...
                    <>
                      ...
                      <StatusWrapper>
                        <StatusContainer>
                          <Status>
                            <StatusTxt
                              status={customerInfo.data.membershipStatus}
                            >
                    ...
                    {"Active as of xx/xx/xxxx"}
                      ...
                      >
                        <ViewMemberId
                          ...
                          onClick={() => history.push(`/idcard`)}
                        >
                          <MemberIcon alt="" src="/react/images/icn-card.svg" />
                          <MemberTxt
                            onClick={() =>
                              handleClickEvent("View Member ID Card")
                            }
                          >
                            View Member ID Card
                          </MemberTxt>
