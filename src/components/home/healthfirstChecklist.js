  ...
  return (
    <>
      ...
      <Card>
        ...
        <CheckListTxt>
          Here’s a checklist to get you started with your Healthfirst health
          plan.
        </CheckListTxt>
        <CheckListCardStep1>
          <Steps>STEP 1</Steps>
          ...
          <Description>
            Once you’ve made your first premium payment, a benfits packet
            containing your Member ID will be mailed to you.
          </Description>
          <Notice>
            <NoticeTxt>
              <b>Important:</b> Complete this step if you’re enrolled in{" "}
              <b>Leaf & Leaf Premier Plans, Essential Plans,</b>
              or{" "}
              <b>
                Child Health Plus — and have a premium obligation to start your
                coverage.
              </b>{" "}
        ...
        <CheckListCardStep2>
          ...
          <Description>
            Once you receive your benefits packet containing your Member ID,
            <AddMemberShip onClick={() => setShowAddMembershipModal(true)}>
              add your membership
            </AddMemberShip>{" "}
            to this account. A new account is not needed.{" "}
          </Description>
        </CheckListCardStep2>
        <CheckListCardStep3>
          <Steps>STEP 3</Steps>
          ...
          <Description>
            Once you add your membership to this account, you'll be able to:
            enroll in AutoPay, search for in-network providers, find essential
            services nearby, access your Member ID card, view claims and
