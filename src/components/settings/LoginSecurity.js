          ...
          !loadingUsername ?
            editUserName ?
              <>
                ...
                <TextBox>
                  <UserImg src="/img/other/ico-account.svg" />
            ...
            editPassword ?
              <>
                ...
                <TextBox error={currPassError}>
                  <UserImg src={currPassError ? "/img/other/ico-lock-red.svg" : "/img/other/ico-lock.svg"} />
                ...
                <TextBox error={newPassError}>
                  <UserImg src={newPassError ? "/img/other/ico-lock-red.svg" : "/img/other/ico-lock.svg"} />
                  ...
                  <OverlayTrigger show={showPopover} placement="top-end" overlay={popoverTop}>
                    <UserImg onMouseEnter={() => setShowPopover(true)} onMouseLeave={() => setShowPopover(false)}
                      src={showPopover ? "/img/other/ico-info-blue.svg" : "/img/gray/ico-info.svg"} width />
                  </OverlayTrigger>
                </TextBox>
                ...
                <TextBox error={confirmPassError}>
                  <UserImg src={confirmPassError ? "/img/other/ico-lock-red.svg" : "/img/other/ico-lock.svg"} />
