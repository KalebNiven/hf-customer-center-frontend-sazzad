...
const LoginSecurity = () => {
  ...
  const handleUserNameChg = (label) => {
    ...
    if (userNameValidation()) {
      ...
      toasterCopy.open = true;
      toasterCopy.message =
        "Invalid username. Please enter at least 3 characters";
  ...
  const popoverTop = (
    <PassPopover>
      ...
      <PasswordText>
        ...
        <PasswordRules>
          Should NOT contain part of your username, first, or last name
        </PasswordRules>
      </PasswordText>
    </PassPopover>
  );
  ...
  const validateNewPass = () => {
    ...
    const validator =
      /[A-Z]/.test(newPassword) && // has a uppercase letter
  ...
  const handleUserNameInputChange = (e) => {
    ...
    if (/^[\w\._@]+$/.test(value) || value.length === 0)
    ...
    <>
      {toasterCopy.open && (
        <Toaster
          ...
          timeout={5000}
          notificationText={toasterCopy.message}
          notificationType={toasterCopy.type}
        />
      )}

      <RightHeader>Login & Security</RightHeader>
      <SubHeader>
        Manage the username and password for your Healthfirst Account.
      </SubHeader>
      <Card>
          ...
          editUserName ? (
            <>
              ...
              <ButtonRow>
                {userName ? (
                  <ChangeButton
                    onClick={() => handleUserNameChg("Change Username")}
                  >
                    Change Username
                  </ChangeButton>
                ) : (
                ...
                <CancelButton onClick={handleUserNameCancel}>
                  Cancel
                </CancelButton>
              </ButtonRow>
            </>
            ...
            <>
              ...
              <TextBox error={currPassError}>
                <UserImg
                  ...
                  src={
                    currPassError
                      ? "/react/images/other/ico-lock-red.svg"
                      : "/react/images/other/ico-lock.svg"
                  }
                />
                <InputBox
                  type="password"
              ...
              <TextBox error={newPassError}>
                ...
                >
                  <UserImg
                    ...
                    src={
                      showPopover
                        ? "/react/images/other/ico-info-blue.svg"
                        : "/react/images/gray/ico-info.svg"
                    }
                    width
                  />
                </OverlayTrigger>
              ...
              <ButtonRow>
                ...
                newPassError === "" &&
                confirmPassError === "" ? (
                  <ChangeButton onClick={handlePasswordChg}>
                    Change Password
                  </ChangeButton>
                ) : (
                  <DisabledButton>Change Password</DisabledButton>
                )}
                <CancelButton onClick={handlePasswordCancel}>
                  Cancel
                </CancelButton>
              </ButtonRow>
            </>
