...
function DigitalId(props) {
  ...
  const checkBenefitPackPPOM = () => customerInfo.data.benefitPackage === "PPOM";
                                            ...
                                            !== null ? (
                                              <div className="row no-gutters">
                                                <div className="col-6 text-left caption-normal light-bold pr-4">
                                                  INDIVIDUAL
                                                  {' '}
                                                  {(digitalIdCard.isIndividualOnly !== true && digitalIdCard.familyDeductible !== null) ? "/FAMILY " : ""}
                                                  {' '}
                                                  DEDUCTIBLE
                                                </div>
                                                <div className="col-6 text-right caption-bold">
