...
const NotificationModal = () => {
  ...
  useEffect(() => {
    sessionStorage.getItem("isNotificationModalClosed") === null &&
      setVisible(true);
  }, []);
      ...
      {visible && (
        <FormModalWrapper>
          <ModalInnerWrapperCustom>
            ...
            <SubHeader>
              <b>Claims</b>, <b>Authorizations</b> and{" "}
              <b>Explanation of Benefits</b> are unavailable at this time.
              Please contact member services using the number on the back of
              your member ID card for assistance.
            </SubHeader>
            <ButtonWrapper>
              <StyledButtonCustom onClick={() => closeModal("Continue")}>
                Continue
              </StyledButtonCustom>
            </ButtonWrapper>
          </ModalInnerWrapperCustom>
