...
import { Button, ButtonsWrapper, CloseIcon, CloseIconWrapper, Description, Dialog, DialogBody, DialogFooter, DialogHeader, Title, Wrappper } from './externalSiteModal';
...
const ACKNOWLEDGMENTS = {
    'Manage Prescriptions': {
        ...
        description: <Description>Starting April 1, 2023, prescription drugs are covered by Medicaid NYRx, the New York State Medicaid pharmacy program. For more information, visit <ExternalSiteLink link="https://member.emedny.org" label="member.emedny.org"  target="_blank" styles={{color: "#008bbf", cursor: "pointer", fontWeight: 700}}>member.emedny.org</ExternalSiteLink> or call <b>1-855-648-1909</b> (TTY 1-800-662-1220). They can answer your call: Monday - Friday, 8am - 8pm Saturday, 9am - 1 pm.</Description>,
        confirmation: 'close'
    }
}
...
const AcknowledgmentModal = () => {
    ...
    const handleClose = () => {
        ...
        AnalyticsTrack(
            "Acknowledgement Modal Resolved", 
            customerInfo,
            {
        ...
        <>
            ...
            <AcknowledgementWrapper>
                <Dialog>
                    ...
                    <DialogFooter>
                        <ButtonsWrapper>
                            <Button onClick={handleClose}>{ACKNOWLEDGMENTS[acknowledgmentModal.label].confirmation}</Button>
                        </ButtonsWrapper>
                    </DialogFooter>
                </Dialog>
            </AcknowledgementWrapper> }
