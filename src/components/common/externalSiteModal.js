...
const ExternalSiteModal = () => {
  ...
  useEffect(() => {
    ...
    homeDetails.externalLinkError,
    homeDetails.externalLinkLoading,
  ]);
  ...
  const handleContinue = (e, link, membershipKey, label) => {
    ...
    AnalyticsTrack(
      ...
      customerInfo,
      {
        ...
        targetMemberId:
          externalSiteModal.segmentTargetMemberId || customerInfo.data.memberId,
        location: {
          desktop: {
            width: 1024,
            value: "center",
        ...
        <Wrappper>
          {membership?.loading ? (
            ...
            <Dialog>
              ...
              <DialogBody>
                <Description>
                  Links to non-Healthfirst websites are provided for your
                  convenience only. Healthfirst is not responsible or liable for
                  the content, accuracy, or privacy practices of linked sites,
                  or of products or services described on these sites.
                </Description>
              </DialogBody>
              <DialogFooter>
                <ButtonsWrapper>
