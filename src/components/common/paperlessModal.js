...
const PaperlessModal = () => {
  ...
  const handleSegmentBtn = (label) => {
    // Segment Track
    AnalyticsTrack(label + " " + "Button clicked", customerInfoData, {
      raw_text: label,
      ...
      {visible && (
        <FormModalWrapper>
          ...
          <ModalInnerWrapperCustom>
            ...
            ></Image>
            <Header>Enroll in Paperless</Header>
            <SubHeader>
              Enroll to get your{" "}
              <CustomTextSpan
              ...
              online instead of by mail, and save paper and time. Your documents
              will be sent to your primary email address as they become
              paperless and available online.
            </SubHeader>
            <ButtonWrapper>
              <LaterButton onClick={() => handleMaybeLater("mayBeLater")}>
                Maybe Later
              </LaterButton>
              <StyledButtonCustom onClick={handleEnrollNow}>
                Enroll Now
              </StyledButtonCustom>
            </ButtonWrapper>
          </ModalInnerWrapperCustom>
