    ...
    const formatMemberDDList = (data) => {
        ...
        if (data.dependents) {
            data.dependents.forEach((dependent) => {
                ...
                isValidDependent = activeDepsOnly ? member.membershipStatus == "active" : true;

                if (isValidDependent) isValidDependent = minorsOnly ? dependent.Age < 18 : true;
        ...
        <>
            ...
            {memberships && memberships.length > 1 && minorsOnly && (
                <MinorText>
                    ...
                    <span>
                        NOTE: Dependents 18 years or older will not be shown
                    </span>
                </MinorText>
            )}
        </>
