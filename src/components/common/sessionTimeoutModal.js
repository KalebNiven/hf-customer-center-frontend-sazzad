...
const SessionTimeoutModal = (props) => {
  ...
  return (
    timeoutVisible && (
      <AppModalWrapper visible={timeoutVisible}>
                ...
                <SessionModalContent>
                  ...
                  <SessionModalBody>
                    <span>
                      ...
                      <cite>{countDownSecondsLeft}</cite> seconds.
                      <br></br>
                  ...
                  <SessionModalFooter>
                    <a
                      id="oktaLogoutUrl"
                      className="btn btn-secondary-md session-sign-out"
                      route="JSON"
                      onClick={() => {
                        logout();
                      }}
                    ...
                    <button
                      id="session-keep-signed-in"
                      type="button"
                      className="btn btn-primary-md session-sign-in"
...
const AppModalContent = styled(ModalContent)`
  ...
  animation-duration: 0.3s /* Add Animation */ @-webkit-keyframes animatetop {
    from {
