        ...
        <Container>
          ...
          {isProceed ? (
            ...
            <MemberCardsContainer>
              <MemberCard>
                {!showRegistration && !showMemberShip && (
                  <BackContainer>
                    <BackIcon
                      data-testid={"back-icon"}
                      onClick={() => handleClick()}
                      src="/react/images/dark/ico-back.svg"
                    ></BackIcon>
                    <BackText
                ...
                {showRegistration ? (
                  <MemberForm
                    ...
                    memberInfomation={(data) => setMemberRegisterDetails(data)}
                  />
                ) : showMemberShip ? (
                  <NonMemberForm
                    onBack={() => setShowMemberShip(false)}
                    handleRegistrationWithId={registrationWithId}
                    isProceedTocrediantials={(data) => {
                      setIsProceed(data);
                    }}
                  />
                  ...
                  <>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="pt-2">
                          <TextWrapper>
                            I am currently enrolled in a Healthfirst plan and
                            have a Member ID, but I do not have an online
                            account.
                          </TextWrapper>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="pt-2">
                          <TextWrapper>
                            I am enrolled in a Healthfirst plan, but my coverage
                            isn't active as I need to make my first premium
                            payment.
                          </TextWrapper>
                        </div>
                      </div>
