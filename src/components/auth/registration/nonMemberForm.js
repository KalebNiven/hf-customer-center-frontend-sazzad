...
const WM_SUB_HEADER =
  "Welcome to the Healthfirst Medicare registration portal.";
const WM_CENTER_INFO =
  ...
  useEffect(() => {
    if (!nonMemberRegister.loading && isContinue) {
      ...
      if (nonMemberRegister?.data?.mfaToken != null) {
        ...
        nonMemberRegister?.error?.message == "Failed recaptcha check"
      ) {
        setGrVersion("V2");
      }
          ...
          case "mobile":
            if (
              (value.value.replace(/-/g, "") === "" ||
                value.value.replace(/-/g, "").length < 10) &&
      ...
      <FormGrid>
        <AdditionalInfo>
          {!wmvalue ? (
            ...
            <CenterInfo>
              To start your Medicare Advantage plan enrollment application,
        ...
        <InputWrapper>
          <InputHeader htmlFor="dob" name="dob">
            Date of Birth{" "}
          </InputHeader>
          <Input
            type="text"
        ...
        <InputWrapper>
          ...
          <Input
            ...
            onPaste={(e) =>
              handleMobileTextPaste(e.clipboardData.getData("text/plain"))
            }
            maxLength={maxlength}
            onSelect={(e) => {
              checkValues();
            ...
            onChange={(e) => {
              ...
              if (
                ...
                (e.target.value.includes("-") && input.length <= 12)
              ) {
      ...
      <FormButtonWrapper>
        {!nonMemberRegister.loading ? (
          <ContinueButton
            variant={varient}
            onClick={() =>
              varient === "primary" ? handleClick(true) : handleClick(false)
            }
          >
            Continue
          </ContinueButton>
