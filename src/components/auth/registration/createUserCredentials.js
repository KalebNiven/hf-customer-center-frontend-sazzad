   ...
   // const registrationOnlyValue = useQuery().get("registrationOnly")
    ...
    const handleSubmit = (trigger) => {
        ...
        if (
            ...
            handleSegmentClick(null,  "Finish Registration", "Finish Registration", "button", "bottom",  "", "registration"); 
    ...
    const checkAllFields = () =>{
        ...
        if( accountInfo["Password"].value.length >1 && 
                    ...
                    <MemberCard>
                        ...
                        <CustomFormWrapper>
                            {!createUsernamePassword.loading ? (
                                <FinishButton
                                    variant={varient}
                                    onClick={() => varient==="primary"? handleSubmit(true):handleSubmit(false)}
                                >
                                    Finish Registration
                                </FinishButton>
                            ) : (
