...
const USER_NOT_FOUND_ERROR =
  "Sorry, we do not recognize the email and/or date of birth you have entered. Please try again. If you need assistance, please call member services.";
const USER_MUTIPLE_MATCHES_ERROR =
  "Multiple matches with the same email and date of birth. Please try again. If you need assistance, please call member services.";
...
const ForgotUsernamePage = () => {
  ...
  const createPayload = () => {
    ...
    payload[`g-recaptcha-response${grVersion === "V3" ? "" : "-v2"}`] =
      grVersion === "V3" ? gRecaptchaResponse : gRecaptchaResponseV2;
    return payload;
  };
  ...
  const submitForm = (e) => {
    ...
    if (validateFields()) {
      handleSegmentClick(
        null,
        "Verify",
        "Forgot Username Credentials Submission",
        "button",
        "bottom",
        "",
        "registration",
  ...
  const renderSwitch = (step) => {
    switch (step) {
      case FORGOT_USERNAME_STEP:
      case DISPLAY_USERNAME_STEP:
        return (
          <>
            <RecaptchaV3
            ...
            {step === FORGOT_USERNAME_STEP && (
              <ForgotCredentialForm onSubmit={(e) => submitForm(e)}>
                ...
                <AuthFormSubtitle>
                  A retrieval code will be sent to you
                </AuthFormSubtitle>
                <InputWrapper>
                  <LabelWrapper>
                    <LabelText htmlFor="email" name="email">
                      Email
                    </LabelText>
                  </LabelWrapper>
                  <InputTextWrapper error={emailError}>
                    ...
                    />
                    <EmailToolTipIcon>
                      <EmailToolTip className="emailToolTip">
                ...
                <InputWrapper>
                  <LabelWrapper>
                    <LabelText htmlFor="dateOfBirth" name="dateOfBirth">
                      Date of Birth
                    </LabelText>
                  </LabelWrapper>
                ...
                {dateOfBirthError && (
                  <ErrorMessage>{dateOfBirthError}</ErrorMessage>
                )}
      ...
      <Wrapper>
        ...
        <Container>
          <ForgotCredentialsLogoWrapper>
            <AuthLogo
              src="/react/images/hf_logo_white.svg"
