...
const BAD_REQUEST_ERROR =
  "Sorry, we do not recognize the username and/or date of birth you have entered. Please try again. If you need assistance, please call member services.";
const PASSWORDS_NOT_MATCHING_ERROR = "Passwords do not match";
const NO_VERIFIED_CHANNELS_ERROR =
  "Sorry, it looks like you did't verify your email or phone. Please call member services for assistance";
...
const ForgotPasswordPage = () => {
  ...
  useEffect(() => {
    if (!mfaFactors?.loading && mfaFactors?.data) {
      const hasVerfiedChannel = mfaFactors?.data?.channels.reduce(
        (accumulator, channel) => {
  ...
  const submitForm = async (e) => {
    ...
    if (validateFields()) {
      ...
      handleSegmentClick(
        null,
        "Verify",
        "Forgot Password Credentials Submission",
        "button",
        "bottom",
        "",
        "registration",
          ...
          <>
            {step === FORGOT_PASSWORD_STEP && (
              <ForgotCredentialForm onSubmit={(e) => submitForm(e)}>
                ...
                <InputWrapper>
                  <LabelWrapper>
                    <LabelText htmlFor="username" name="username">
                      Username
                    </LabelText>
                  </LabelWrapper>
                ...
                <InputWrapper style={{ height: "78px" }}>
                  {grVersion === "V2" && (
                    <RecaptchaV2 setV2Response={setGRecaptchaResponseV2} />
                  )}
                </InputWrapper>
            ...
            {step === RESET_PASSWORD_STEP && (
              <ForgotCredentialForm onSubmit={(e) => handleResetPassword(e)}>
                ...
                <InputWrapper>
                  <LabelWrapper>
                    <LabelText htmlFor="password" name="password">
                      Password
                    </LabelText>
                  </LabelWrapper>
                  <InputTextWrapper error={passwordError}>
                    ...
                    <PasswordToolTipIcon>
                      <PasswordToolTip
                        visible={
                          passwordError.length < 1 ? "hidden" : "visible"
                        }
                      ...
                      >
                        ...
                        <ul>
                          ...
                          <li>
                            - Should NOT contain part<br></br>
                            &nbsp;&nbsp;&nbsp;of your username, first,<br></br>
                            &nbsp;&nbsp;&nbsp;or last name
                          </li>
                        </ul>
                      </PasswordToolTip>
