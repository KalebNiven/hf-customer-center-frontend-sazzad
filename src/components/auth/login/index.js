        ...
        <Form onSubmit={(e) => handleSubmit(e)}>
              ...
              <LabelLink
                onClick={() =>
                  handleSegmentClick(
                    "/forgotUsername",
                    "Forgot Username",
                    "Redirect to forgot username page",
                    "link",
                    "right",
                    "",
                    "registration",
          ...
          <CheckBoxWrapper error={error}>
            <CheckBox
              id="saveUsername"
              type="checkbox"
              data-type="saveUsername"
              checked={saveUsername}
              onChange={(e) => handleChange(e)}
              disabled={loading}
            />
            <CheckBoxLabel htmlFor="saveUsername" name="save username">
              Remember Username
            </CheckBoxLabel>
          </CheckBoxWrapper>
            ...
            <a
              onClick={() =>
                handleSegmentClick(
                  ...
                  "Visit Healthfirst.org",
                  "Redirect Healthfirst home page",
                  "link",
                  "bottom",
                  "",
                  "registration",
...
export const SubmitButton = styled.button`
  ...
  ${(props) => props.disabled && `color: #757575; background: #D8D8D8;`};
`;
