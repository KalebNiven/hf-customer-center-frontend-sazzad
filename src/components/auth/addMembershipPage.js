...
import { Container, Footer, FooterMenuWrapper, Form, LanguageSelectionWrapper, Logo, LogoWrapper, SubmitButton, Wrapper } from "./login";
            ...
            case 'addMember': 
                return(
                    <FormWrapper>
                        ...
                        <Header>Welcome Back,<br/>Please Enter Your Member ID</Header>
                        <SubHeader>
                            ...
                            <InputWrapper>
                                ...
                                <MemberIdInput>
                                    ...
                                    <AddMembershipToolTip>
                                        <AddMembershipToolTipText className="addMembershipToolTip">This can be found on your Healthfirst Member ID card.</AddMembershipToolTipText>
                                    </AddMembershipToolTip>
                                </MemberIdInput>
                            </InputWrapper>
                            <AdditionalInfo>
