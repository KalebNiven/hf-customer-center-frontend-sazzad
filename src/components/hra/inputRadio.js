...
const InputRadio = ({
  ...
  return (
    ...
    >
      <Label htmlFor={`${itemId}-${code}`}>
        <LabelRadio>
          <Input
            ...
            id={`${itemId}-${code}`}
            checked={
              (selected[itemId] && selected[itemId][0].answer_code == code) ||
              ""
            }
      ...
      {selected[itemId] &&
        selected[itemId][0].answer_code == code &&
        answer_with_text && (
          <TextAreaWrapper>
            <TextArea
              ...
              value={
                (selected[itemId] && selected[itemId][0].answer_value) || ""
              }
            ></TextArea>
            <TextCount>
              {(selected[itemId][0].answer_value &&
                selected[itemId][0].answer_value.length) ||
                0}
              /250
            </TextCount>
          </TextAreaWrapper>
