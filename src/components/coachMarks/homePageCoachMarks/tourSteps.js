export const desktopStepsState = [
  {
    ...
    content:
      "Access your Member ID, Benefits, Claims, and Authorizations within My Plan. ",
    isFixed: true,
    disableBeacon: true,
    offset: 0,
    stepType: "desktop",
  ...
  },
  {
    ...
    content:
      "Conveniently find doctors, urgent care centers, pharmacies, and other healthcare providers in our network using our enhanced search tools. ",
    isFixed: true,
    disableBeacon: true,
    offset: -7,
    stepType: "desktop",
  ...
  },
  {
    ...
    content:
      "Need to make payments? Easily set up automatic payments in our updated payment system.",
    isFixed: true,
    disableBeacon: true,
    offset: -7,
    stepType: "desktop",
  ...
  },
  {
    ...
    content:
      "Take your Annual Health Assessment and connect to community resources in your area.",
    isFixed: true,
    disableBeacon: true,
    offset: -7,
    stepType: "desktop",
...
export const mobileStepsState = [
  {
    ...
    title: "Menu",
    content:
      "Open this menu to navigate to other features. Tap the Menu icon to continue.",
    disableBeacon: true,
