    ...
    <EndTourScreenWrapper>
      <Overlay>
        <ModalWrapper>
          ...
          <Description>
            Use our Healthfirst NY Mobile App to find care that's in your
            network, locate essential services nearby, view your digital member
            ID, and more.
          </Description>
          <Downloads>
            <ExternalSiteLink
              link="https://apps.apple.com/us/app/healthfirst-ny/id1464792066"
              target="_blank"
              label="apps.apple.com"
              segmentTrack="External Service Launched"
              segmentProps="{{ json_encode(['service_name' => 'AppStore', 'raw_text' => 'Download App', 'destination_url' => 'https://apps.apple.com/us/app/healthfirst-ny/id1464792066' ]) }}"
            >
              <DownloadImg
                isFirst
                src="/react/images/download-on-the-app-store-badge.svg"
              />
            </ExternalSiteLink>
            <ExternalSiteLink
              link="https://play.google.com/store/apps/details?id=org.healthfirst.android.member"
              label="play.google.com"
              target="_blank"
              segmentTrack="External Service Launched"
              segmentProps="{{ json_encode(['service_name' => 'Google Play', 'raw_text' => 'Download App', 'destination_url' => 'https://play.google.com/store/apps/details?id=org.healthfirst.android.member' ]) }}"
            >
              <DownloadImg src="/react/images/download-google-play-badge.svg" />
            </ExternalSiteLink>
          </Downloads>
          <ButtonsWrapper>
            <Button outlined={true} onClick={goBack} isFirst>
              Back
            </Button>
