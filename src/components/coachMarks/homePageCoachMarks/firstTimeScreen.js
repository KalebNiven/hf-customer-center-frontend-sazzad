    ...
    <FirstTimeScreenWrapper visible={visible}>
      <Overlay>
        <ModalWrapper>
          ...
          <Title>
            Welcome, <FirstName>{firstName}</FirstName>
          </Title>
          <Description>
            Healthfirst has been working hard to provide it’s members the best
            user experience. Take a tour to see what’s new.
          </Description>
          <ButtonsWrapper>
            <Button outlined={true} onClick={handleEndTour}>
              No Thanks
            </Button>
            <Button onClick={() => handleSegmentBtn("Lets Go")}>
              Let's Go
            </Button>
          </ButtonsWrapper>
        </ModalWrapper>
