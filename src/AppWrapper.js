...
const AppWrapper = () => {
  ...
  if (!authState && location.pathname !== "/login/callback")
      ...
      <Provider store={store}>
        <UnauthenticatedUserWrapper>
          <Switch>
            ...
            <Route
              exact
              path="/questionnaire/:lob"
              component={QuestionnaireLIPPage}
            />
            {/* Util Routes */}
            ...
            <Route
              ...
              path="*"
              component={() => (
                <NotFound404Page isAuthenticated={authState?.isAuthenticated} />
              )}
            />
          </Switch>
        </UnauthenticatedUserWrapper>
        ...
        <AuthenticatedUserWrapper>
          <Switch>
            ...
            <SecureRoute
              ...
              component={AuthorizationsDetailsPage}
            />
            <SecureRoute
              exact
              path="/coverage-and-benefits"
              component={CoverageAndBenefitsPage}
            />
            <SecureRoute
              exact
              path="/documents/:id"
              component={DocumentsCenterDetailsPage}
            />
            <SecureRoute
              exact
            ...
            <SecureRoute
              ...
              component={FormsAndDocumentPage}
            />
            <SecureRoute
              exact
            ...
            <SecureRoute
              exact
              path="/communityResources/category"
              component={CommunityResourcesCategoryPage}
            />
            <SecureRoute
              exact
              path="/communityResources/details"
              component={CommunityResourcesDetailsPage}
            />
            ...
            />
            <SecureRoute
              path="/signatureChecklist"
              component={SignatureChecklistPage}
            />
            <SecureRoute
              exact
              path="/addMembership"
            ...
            <SecureRoute
              exact
              path="/selectPreferredContacts"
              component={SelectPreferredContactsPage}
            />
            <SecureRoute
              exact
              path="/my-health/my-health-checklist"
              component={MyHealthCheckListPage}
            />
            <SecureRoute exact path="/my-rewards" component={MyRewardsPage} />
            <SecureRoute
              exact
              path="/my-health/community-resources"
              component={CommunityResourcesPage}
            />
            <SecureRoute
              exact
              path="/my-health/annual-health-assessment"
              component={AnnualHealthAssessmentPage}
            />
            <SecureRoute
              exact
              path="/my-health/community-resources/category"
              component={CommunityResourcesCategoryPage}
            />
            <SecureRoute
              exact
              path="/my-health/community-resources/details"
              component={CommunityResourcesDetailsPage}
            />
            {/* Util Routes */}
            ...
            <SecureRoute
              exact
              path="/selectLanguage"
              component={HandleLanguageSelection}
            />
            <SecureRoute exact path="/otc-widget" component={OTCWidgetPage} />

            <SecureRoute
              exact
              path="/success-medicare"
              component={FormSuccessMedicareCard}
            />
