...
export const SSOModalContextProvider = ({ children }) => {
    const initState = { routeLink: '', externalLinkName: '', showMemberModal: false, membershipKey: null }
    ...
    return (
        <SSOModalContext.Provider value={{ ssoModalState, setSsoModalState, resetSsoModal }}>{children}</SSOModalContext.Provider>
    )
}
