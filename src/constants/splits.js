...
export const SHOW_PAYMENTS_REACT_APP = "CustomerCenter_NewPaymentPortal";
...
export const getFeatureFlagList = () => {
  return [SHOW_CLAIMS, SHOW_AUTHS, SHOW_MORE_TOOLS, SHOW_MAIL_ID_CARD,
    ...
    SHOW_CLAIMS_EXPLANATION_OF_BENEFITS, SHOW_OTC_CARD_HOME_PAGE, SHOW_OTC_CARD_ACTIVATION_PAGE, SHOW_SHOP_ONLINE_HOME_PAGE, SHOW_CLAIMS_EXPLANATION_OF_BENEFITS, SHOW_COST_ESTIMATOR_WIDGET, SHOW_OTC_LEARN_MORE_BUTTON, SHOW_OTC_BENEFITS_CENTER_BUTTON, SHOW_OTC_ACTIVATE_BUTTON
  ];
};