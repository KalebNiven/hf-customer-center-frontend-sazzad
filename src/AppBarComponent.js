...
function AppBarComponent() {
  ...
  const userName = `${firstName} ${
    customerInfo?.data?.hohPlans[0]
      ? customerInfo?.data?.hohPlans[0]?.LastName
      : ""
  }`;
  ...
  const splitAttribute = () => {
    customerInfo.data.accountStatus === "NON-MEMBER"
  ...
  const checkTreatment = (
    ...
    if (
      !splitHookClient ||
      paymentsEnabledTreatment.treatment === "control" ||
      binderEnabledTreatment.treatment === "control" ||
      showReactPaymentsPortal.treatment === "control"
    )
      return;
    setPaymentsEnabled(
  ...
  const checkPaymentsACLs = () => {
    if (customerInfo?.data?.accountStatus === "NON-MEMBER") {
      return true;
    }
  ...
  const getParentNav = () => (
    <div
      id="navbar"
      style={{ display: "flex", height: "64px", paddingLeft: "15px" }}
    >
      <Tabs
        value={value}
        TabIndicatorProps={{ style: { position: "absolute", left: "-999px" } }}
        onChange={handlTabs}
      >
  ...
  const getChildNav = () => {
    ...
    if (
      ...
      window.location.pathname === "/my-health" ||
      window.location.pathname === "/my-health/community-resources" ||
      window.location.pathname === "/my-health/annual-health-assessment" ||
      window.location.pathname === "/my-health/my-health-checklist"
    ) {
      currentTab = navItems[4];
      childNavs = currentTab?.childNavs;
    } else if (
      window.location.pathname === "/communityResources" ||
      window.location.pathname === "/testout"
    ) {
      currentTab = navItems[4];
      childNavs = currentTab?.childNavs;
    } else {
        ...
        >
          {childNavs &&
            ...
            childNavs.map((eachNav, ind) =>
              ...
              eachNav.treatmentName === SHOW_HEALTH_ASSESMENT_SURVEY ? (
                splitEval.evaluateSplitByName(eachNav.treatmentName) && (
                  <Tab
                    label={eachNav.label}
                    onClick={(e) =>
                      handleClick(
                  ...
                  {eachNav.treatmentName ? (
                                ...
                                {eachNav.href === "/home" && (
                                  <>
                                    ...
                                    myHomeObj.childNavs.find(
                                      ...
                                      <LogoImg
                                        alt=""
                                        src={eachNav.activeIcon}
                                      />
                                    ) : (
                                      <LogoImg
                                        alt=""
                                        src={eachNav.inactiveIcon}
                                      />
                                    )}
                                  </>
                                )}
                                  ...
                                  >
                                    <LogoImg
                                      ...
                                      src={
                                        ...
                                        (eachNav.href === "/findcare" &&
                                          findCareMobileItems)
                                          ? `/react/images/icn-up-arrow.svg`
                                          : `/react/images/icn-down-arrow.svg`
                                      }
                                    />
                                  </ListItemIcon>
                                )}
                    ...
                    <div key={index} className={`${eachNav?.mobileCoachmark}`}>
                      ...
                      >
                        ...
                        {eachNav.type === "navItem" &&
                          ["/my-health"].some((x) => x === eachNav.href) && (
                            <ListItemIcon
                              onClick={(e) =>
                                onCollapseExpand(e, eachNav.href, "parent")
                              }
      ...
      <>
        ...
        <Hidden only={["xs", "sm"]}>
          <AppBar
            position="sticky"
            className="no-print"
            style={{ color: "black", zIndex: 500, boxShadow: "none" }}
          >
            {getParentNav()}
            {getChildNav()}
          </AppBar>
            ...
            <ThemeProvider theme={theme}>
              ...
              >
                ...
                <IconButton
                  ...
                  className={`navbar-hamburger-coachmarks no-print ${
                ...
                >
                  {!drawerOpen ? (
                    <MobileHamburgerImg
                      alt=""
                      src={`/react/images/icn-hamburger.svg`}
                    />
                  ) : (
                    <MobileCloseImg
                      alt=""
